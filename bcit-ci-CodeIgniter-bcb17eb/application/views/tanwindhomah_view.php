...
<body>
    <div class="navbar">
        <ul>
            ...
            <li><a href="<?php echo site_url('tanwindhomah'); ?>" class="active">Tanwin Dhomah</a></li>
            <li><a href="<?php echo site_url('tanwinkasroh'); ?>">Tanwin Kasroh</a></li>
            <li><a href="<?php echo site_url('tajwid'); ?>">Tajwid</a></li>
        </ul>
    </div>
    <div class="container">
        <h2>Halaman Tanwin Dhomah</h2>
        <div class="placeholder">Konten Tanwin Dhomah akan ditampilkan di sini.</div>
    </div>
</body>
</html> 