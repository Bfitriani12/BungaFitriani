...
<body>
    <div class="navbar">
        <ul>
            ...
            <li><a href="<?php echo site_url('tanwinkasroh'); ?>" class="active">Tanwin Kasroh</a></li>
            <li><a href="<?php echo site_url('tajwid'); ?>">Tajwid</a></li>
        </ul>
    </div>
    <div class="container">
        <h2>Halaman Tanwin Kasroh</h2>
        <div class="placeholder">Konten Tanwin Kasroh akan ditampilkan di sini.</div>
    </div>
</body>
</html> 