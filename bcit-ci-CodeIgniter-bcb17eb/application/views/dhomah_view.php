...
<head>
    ...
    <style>
        ...
        /* Warna kartu berbeda */
        .warna-1 { background: #fef9c3; }
        .warna-2 { background: #fde68a; }
        .warna-3 { background: #fbbf24; }
        .warna-4 { background: #f59e42; }
...
<body>
    ...
    <div class="container">
        <div class="nav-buttons">
            ...
            <a href="<?php echo site_url('dhomah/practice'); ?>" class="nav-btn" style="background:#22c55e;">Latihan</a>
        ...
        <div class="grid">
            ...
            <a class="huruf-link" href="<?php echo site_url('dhomah/detail/' . $huruf['latin']); ?>">
                <div class="huruf-card warna-<?php echo ($index % 28) + 1; ?>">
                    <div class="dhomah-strip"></div>
