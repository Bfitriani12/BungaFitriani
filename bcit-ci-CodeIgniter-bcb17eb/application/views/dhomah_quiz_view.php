    ...
    <div class="container">
        <div class="quiz-card">
            ...
            <div class="navigation">
                ...
                <button onclick="restartQuiz()" class="nav-btn" style="background: #fbbf24;">🔄 Mulai Ulang</button>
            </div>
        </div>
    </div>
    <script>
            ...
            container.innerHTML = `
                <div style="text-align: center;">
                    ...
                    <p style="font-size: 1.2em; margin: 20px 0;">
                        ${score === totalQuestions ? '🎉 Sempurna! Kamu sudah menguasai Dhomah!' : 
                          score >= totalQuestions * 0.8 ? '👍 Bagus! Kamu hampir menguasai Dhomah!' :
