    ...
    <div class="container">
        <div class="quiz-card">
            ...
            <div class="navigation">
                ...
                <button onclick="restartQuiz()" class="nav-btn" style="background: #FF9800;">🔄 Mulai Ulang</button>
            </div>
        </div>
    </div>
            ...
            container.innerHTML = `
                <div style="text-align: center;">
                    ...
                    <p style="font-size: 1.2em; margin: 20px 0;">
                        ${score === totalQuestions ? '🎉 Sempurna! Kamu sudah menguasai Fathah!' : 
                          score >= totalQuestions * 0.8 ? '👍 Bagus! Kamu hampir menguasai Fathah!' :
