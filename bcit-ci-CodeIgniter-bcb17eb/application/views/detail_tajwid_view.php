        ...
        <div class="card">
            ...
            <?php elseif (isset($tajwid['slug']) && $tajwid['slug'] === 'ghunnah'): ?>
                ...
                <ul class="mad-list">
                    ...
                    <li><b>Nun/Mim Tasydid:</b> إِنَّ dibaca "inna" (dengung pada "nn")</li>
                    <li><b>سَمِيعٌ مَّبْصِيرٌ</b> (dengung pada "mm")</li>
                </ul>
                <div class="section-title">💡 Catatan</div>
            ...
            <?php elseif (isset($tajwid['slug']) && $tajwid['slug'] === 'idgham'): ?>
                ...
                <ul class="mad-list">
                    ...
                    <li><b>Idgham Bilaghunnah</b> (tanpa dengung): jika bertemu ل, ر. Dibaca tanpa dengung.<br>
                        <span class="example-box">Contoh: مِنْ رَبِّهِمْ dibaca "mir-rabbihim"</span>
                    </li>
                </ul>
                ...
                <ul class="mad-list">
                    ...
                    <li>مِنْ رَبِّهِمْ → dibaca "mir-rabbihim" (idgham bilaghunnah)</li>
                </ul>
                <div class="section-title">💡 Catatan</div>
            ...
            <?php elseif (isset($tajwid['slug']) && $tajwid['slug'] === 'idhar'): ?>
                <div class="tajwid-title">👁️ Idhar 👁️</div>
